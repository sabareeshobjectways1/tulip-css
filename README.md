...
This markdown file is now ready to be saved as `README.md` in the root of your project. When viewed on platforms like GitHub, GitLab, or Bitbucket, the code blocks will be nicely formatted.
